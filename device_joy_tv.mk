...
$(call inherit-product-if-exists, vendor/explay/joy_tv/joy_tv-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/explay/joy_tv/overlay

LOCAL_PATH := device/explay/joy_tv
